            ...
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('product.update', $data->id) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('title', $data->title) }}" autofocus type="text"
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <input id="desc" type="hidden" name="desc" value="{{ old('desc', $data->desc) }}">
                        <trix-editor class="text-light" input="desc"></trix-editor>
                    </div>
                    <div class="form-group mt-2">
                        <label for="price">Harga</label>
                        <input value="{{ old('price', $data->price) }}" required type="number"
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input value="{{ old('link', $data->link) }}" required type="url"
                    ...
                    <div class="form-group mt-2">
                        ...
                        <div class="row @error('size') is-invalid @enderror">
                            @foreach ($size as $sizes)
                                <div class="col-1">
                                    <input type="checkbox" value="{{ $sizes }}" name="size[]" id="size"
